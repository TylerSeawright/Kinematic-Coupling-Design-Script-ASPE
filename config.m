...
F_Preload = [0 0 -10; ... % [N] F_Preload are preload force vectors
             0 0 0;
             0 0 0]';
F_Preload_Location = [-30 0 0; ... % [mm] F_Preload_Location are preload force position vectors relative to each ball center [x1, y1, z1; x2 ...]
                      0 0 0;
                      0 0 0]';
F_Applied = [0 0 -100]'; % [N] F_Applied is list of clamp loads at FL_loc [x1, y1, z1; x2 ...]
F_Applied_Location = [0,0,20]'; % [mm] FL_loc is list of clamp load locations [x1, y1, z1; x2 ...]

M_Preload = [0,0,0]'; % [N-m] M_PL is list of clamp preload moments applied to the ball pallet
M_Applied = [0,0,1]'; % [N-m] M_L is list of clamp moments applied to the ball pallet
...
if (TG.rotinputs)
    ...
    F_Applied_Location = data_transform(inputTranRot, F_Applied_Location')';
    F_Applied = data_transform(inputRotate,F_Applied')';
    F_Preload_Location = data_transform(inputTranRot, F_Preload_Location')';
    F_Preload = data_transform(inputRotate,F_Preload')';
