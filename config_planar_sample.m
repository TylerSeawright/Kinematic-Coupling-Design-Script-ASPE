...
%% Forces
F_PL = [0 0 -51.5; ... % F_PL are preload force vectors
        0 0 0;
        0 0 0]';
% F_PL_loc = [-23 0 71.42; ... % F_PL_loc are preload force position vectors relative to each ball center [x1, y1, z1; x2 ...]
%             0 0 0;
%             0 0 0]';
...
F_L = [0 0 -189]'; % F_L is list of clamp loads at FL_loc [x1, y1, z1; x2 ...]
M_L = [0,0,0]'; % M_L is list of clamp moments applied to the ball pallet
F_L_loc = [0,0,10]'; % FL_loc is list of clamp load locations [x1, y1, z1; x2 ...]
