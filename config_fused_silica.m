...
F_P_is_equal = 1;               % Control if all F_P magnitudes are equal. 1 for all equal, 0 for specific vectors, 2 for solve via superposition of load in first column
...
KC_custom_Pct = [104, 55, 0; ...
                 ...
                 0, -138, 0]'; 
% - Ball Bodies
Ball_dia_nom = 20*ones(1,3);      %[mm] Nominal Ball Diameters
...
F_L = [0 0 -0.5]'; % F_L is list of clamp loads at FL_loc [x1, y1, z1; x2 ...]
...
poi = [500,0,0; ...
       0, 0, 500;
       0, 500, 0]; % POI [mm] is a set of points of interest to solve error about in the input Csys.
%% MATERIALS
mu_f = 0;               % Coeff of friction between ball and vee materials, 0 for no friction
mat_index = [10,5];      % Variable to store which rows of material lib used. First index is ball, second is vee.
