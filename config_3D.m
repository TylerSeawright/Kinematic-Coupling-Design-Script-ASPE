...
% degrees.
inRx = 0; inRy = -pi/2; inRz = 0; % Rotation Angles
...
vee_reorient = [0 0 -pi/2; 0 0 pi/2; 0 0 0]; % [rad], controls vee orientation, [0,0,0] is vee pointing towards centroid. CHECK INPUT CSYS
%% FORCES
F_Preload = [10 0 0; ... % [N] F_Preload are preload force vectors
             0 0 0;
             0 0 0]';
F_Preload_Location = [0 0 0; ... % [mm] F_Preload_Location are preload force position vectors relative to each ball center [x1, y1, z1; x2 ...]
                      0 0 0;
                      0 0 0]';
F_Applied = [100 0 0]'; % [N] F_Applied is list of clamp loads at FL_loc [x1, y1, z1; x2 ...]
